...
L["DIAG_TIP_SPAM"] = "Sends the same line three times through the real path, as a stranger would. Leaves one entry in the Journal, in the channel category."
...
L["DIAG_TIP_SPAM"] = "Envoie trois fois la m\195\170me ligne par le vrai chemin, comme le ferait un inconnu. Laisse une entr\195\169e dans le Journal, dans la cat\195\169gorie canal."
