...
L["WL_BNET_HINT"] = "Sanctuary never blocks your Battle.net friends on Battle.net. To cut one off, remove them in Battle.net."
...
L["PANEL_BLOCKED_BNET"] = "A Battle.net friend cannot be blocked here: remove them in Battle.net."
...
L["WL_BNET_HINT"] = "Vos amis Battle.net ne sont jamais bloqu\195\169s sur Battle.net par Sanctuary. Pour en couper un, retirez-le dans Battle.net."
...
L["PANEL_BLOCKED_BNET"] = "Un ami Battle.net ne peut pas \195\170tre bloqu\195\169 ici : retirez-le dans Battle.net."
