...
-- The language menu. Each language is listed in its own name, in the code; only
-- the first row and the dialog are translated.
L["ADV_LANGUAGE_TITLE"] = "Language"
L["LANGUAGE_AUTO"] = "Game language (auto)"
L["LANGUAGE_TIP"] = "The language of Sanctuary's window and messages. The game keeps its own."
L["LANGUAGE_RELOAD_TEXT"] = "The new language appears after the interface reloads."
L["LANGUAGE_RELOAD_NOW"] = "Reload now"
L["LANGUAGE_RELOAD_LATER"] = "Later"
